...
int main() {
    std::cout << "Testing stat operation on root directory..." << std::endl;
    ...
    std::cout << "Testing stat on root directory (empty UID)..." << std::endl;
    ...
    std::cout << "Stat test completed!" << std::endl;
    return 0;
}