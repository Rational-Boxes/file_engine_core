...
int main() {
    std::cout << "Testing direct filesystem operations..." << std::endl;
    ...
    // Test creating a directory with empty tenant (should use default tenant)
    std::cout << "Testing mkdir with empty tenant (should use 'default')..." << std::endl;
    ...
    if (result.success) {
        ...
        std::cout << "Testing touch operation..." << std::endl;
        ...
        if (file_result.success) {
            ...
            if (put_result.success) {
                ...
                if (get_result.success) {
                    std::cout << "Successfully got content from file!" << std::endl;
                    std::string content_str(get_result.value.begin(), get_result.value.end());
                    std::cout << "Content: " << content_str << std::endl;
                } else {
                    std::cout << "Failed to get content from file: " << get_result.error << std::endl;
                }
            } else {
